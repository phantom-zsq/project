 ...
 */
package com.phantom.hadoop.examples.dancing;
 ...
 * 
 * The application gives each column a name and each row is named after the set
 * of columns that it has as true. Solutions are passed back by giving the
 * selected rows' names.
 * 
...
public class DancingLinks<ColumnName> {
	...
	private static class Node<ColumnName> {
		...
		Node(Node<ColumnName> l, Node<ColumnName> r, Node<ColumnName> u, Node<ColumnName> d,

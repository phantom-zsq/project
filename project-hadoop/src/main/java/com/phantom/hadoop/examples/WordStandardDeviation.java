...
public class WordStandardDeviation extends Configured implements Tool {
	...
	/**
	 * Maps words from line of text into 3 key-value pairs; one key-value pair
	 * for counting the word, one for counting its length, and one for counting
	 * the square of its length.
	 */
	public static class WordStandardDeviationMapper extends Mapper<Object, Text, Text, LongWritable> {
	 ...
	 */
	public static class WordStandardDeviationReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
	...
	/**
	 * Reads the output file and parses the summation of lengths, the word
	 * count, and the lengths squared, to perform a quick calculation of the
	 * standard deviation.
	 * 
	 * @param path

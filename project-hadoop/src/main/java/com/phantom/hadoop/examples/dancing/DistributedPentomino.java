...
public class DistributedPentomino extends Configured implements Tool {
	...
	public static class PentMap extends Mapper<WritableComparable<?>, Text, Text, Text> {
		 ...
		 * with that prefix.
		 */
		public void map(WritableComparable<?> key, Text value, Context context) throws IOException {
			prefixString = value;
		...
		public void setup(Context context) {
			...
			pent = (Pentomino) ReflectionUtils.newInstance(conf.getClass(Pentomino.CLASS, OneSidedPentomino.class),
					conf);

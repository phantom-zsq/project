...
public class DefaultMasterFailureMonitor implements MasterFailureMonitor {
	...
	private List<MasterState> masterStateList = new ArrayList<MasterState>(
			MasterFailureMonitor.DEFAULT_STORE_MASTER_STATE_SIZE);
	...
	public void setMonitorInterval(long monitorInterval) {
		this.monitorInterval = monitorInterval < DEFAULT_FAILURE_MONITOR_INTERVAL ? DEFAULT_FAILURE_MONITOR_INTERVAL
				: monitorInterval;
	}

	public void setWaitMasterStateTimeout(long waitMasterStateTimeout) {
		this.waitMasterStateTimeout = waitMasterStateTimeout < DEFAULT_FAILURE_MONITOR_WAIT_MASTER_STATE_TIME_OUT
				? DEFAULT_FAILURE_MONITOR_WAIT_MASTER_STATE_TIME_OUT : waitMasterStateTimeout;
	}
}

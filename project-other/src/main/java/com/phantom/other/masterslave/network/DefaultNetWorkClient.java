...
import com.phantom.other.masterslave.command.CommandFactory;
...
public class DefaultNetWorkClient implements NetWorkClient, Runnable {
	...
	public void start() {
		...
		heartbeatScheduler.scheduleAtFixedRate(new HeartbeatTask(), NetWorkConstants.DEFAULT_MS_HEART_BEAT_INTERVAL,
				NetWorkConstants.DEFAULT_MS_HEART_BEAT_INTERVAL, TimeUnit.SECONDS);
	}
	...
	@Override
	public void run() {
		log.info(new StringBuilder("MS-NetWork-Clent started, connected to Server: ")
